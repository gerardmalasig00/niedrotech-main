  ...
  return (
    <>
      <Layout breadcrumbTitle="Service Details">
            ...
            <div className="row align-items-center">
              <div className="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                <div className="image_box">
                  <img
                    src="/assets/images/service/ser-v1-1-min.png"
                    className="img-fluid"
                    alt="img"
                  />
                </div>
              ...
              <div className="col-lg-6 col-md-6 col-sm-6 col-xs-12 pd_left_30">
                ...
                <div className="section_title type_one">
                  ...
                  <p>
                    ...
                    blandit orci. Sed egestas tellus est aliquet egetristique
                    nisullam pharetra sed tempor sed eivera consectetur augue
                  </p>
                  {/*-============spacing==========-*/}
            ...
            <div className="row">
                ...
                <div className="icon_box_only type_five color_two d-flex  trans">
                  ...
                  <div className="content">
                    <div className="title_22">
                      <Link href="#">
                        {" "}
                        Commercial Property <br /> Insurance{" "}
                      </Link>
                    </div>
                  </div>
                </div>
              ...
              <div className="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                <div className="image_box mr_bottom_minus_200  position-relative z_2">
                  <img
                    src="/assets/images/service/ser-v1-2-min.png"
                    className="img-fluid"
                    alt="img"
                  />
                </div>
        ...
        {/*-service*/}
        <section
          className="service-section position-relative bg_op_1 overflow-hidden"
          style={{ backgroundImage: "url(assets/images/ser-bg-bg-min.jpg)" }}
        >
          {/*-============spacing==========-*/}
                ...
                <div className="icon_box_only type_one color_two">
                  <div className="icon_box_in trans">
                    <div className="shape_image">
                      ...
                      >
                        <path
                          d="M19.8056 39.6223L0.500244 0H17.5002L36.1734 36.0124L19.8056 39.6223Z"
                          fill="var(--color-set-one-1)"
                        />
                        <path
                          className="two"
                          d="M36.8216 44.7789L19.8086 39.6339L41.3565 29.0508L58.4829 34.1875L36.8216 44.7789Z"
                          fill="var(--color-set-one-2)"
                        />
                        <path
                          className="two"
                          d="M75.3704 66.1668L58.0938 61.0318L80.9934 52.772L98.1198 57.9087L75.3704 66.1668Z"
                          fill="var(--color-set-one-2)"
                        />
                        <path
                          d="M41.3564 29.0508L58.0936 61.0319L71.4346 56.223L60.3526 34.7522L41.3564 29.0508Z"
                          fill="var(--color-set-one-1)"
                        />
                        <path
                          d="M80.9629 52.792L116 121V91.5L99.9591 58.4917"
                          fill="var(--color-set-one-1)"
                        />
                      </svg>
                    </div>
                ...
                <div className="icon_box_only type_one color_two">
                  <div className="icon_box_in trans">
                    ...
                    <div className="title_22">
                      <Link href="#">
                        {" "}
                        We’re Trusted <br /> &amp; Save your Money{" "}
                      </Link>
                    </div>
                    <Link className="rd_more" href="#">
                      {" "}
                ...
                <div className="icon_box_only type_one color_two">
                  <div className="icon_box_in trans">
                    ...
                    <div className="title_22">
                      <Link href="#">
                        {" "}
                        So Much <br /> Fast &amp; Eeliable Services{" "}
                      </Link>
                    </div>
                    <Link className="rd_more" href="#">
                      {" "}
          ...
          <div className="container">
            <div className="row align-items-center">
              <div className="col-lg-6 col-md-6 col-sm-12">
                <div className="image_box">
                  <img
                    src="/assets/images/service/ser-v1-3-min.png"
                    alt="img"
                    className="img-fluid"
                  />
                </div>
              ...
              <div className="col-lg-6 col-md-6 col-sm-12 pd_left_30">
                ...
                <div className="position-relative br_left_3px_theme_color pd_left_10">
                  ...
                  accusantium doloremque laudantium aperiam eaquecy inventore
                ...
                <div className="block_faq">
                  <div className="accordion-box">
                    ...
                    >
                      ...
                      >
                        {" "}
                        Quis autem vel eum iure reprehenderit ea voluptate esse
                        molestiae consequatur veillum voluptas nullaes{" "}
                      </div>
                    </div>
                    <div
                      className={
              ...
              <div className="col-lg-12">
                <section className="fom_tab_box custom_tabs type_four">
                  ...
                  <div className="s_tabs_content tab-content">
                    ...
                    >
                      <div className="contentbox  yes_image d-flex ">
                        ...
                        <div className="image trans">
                          <img
                            src="/assets/images/frm-1-min.png"
                            alt="img"
                            className="img-fluid"
                          />
                        </div>
                    ...
                    <div
                      className={
                        activeIndex === 3 ? "tab-pane active" : "tab-pane"
                      }
                    >
                      <div className="contentbox  yes_image d-flex ">
                        <div className="contact_form_shortcode">
                    ...
                    <div
                      className={
                        activeIndex === 4 ? "tab-pane active" : "tab-pane"
                      }
                    >
                      <div className="contentbox  yes_image d-flex ">
                        <div className="contact_form_shortcode">
                    ...
                    <div
                      className={
                        activeIndex === 5 ? "tab-pane active" : "tab-pane"
                      }
                    >
                      <div className="contentbox  yes_image d-flex ">
                        <div className="contact_form_shortcode">
