                ...
                <div className="service_box type_one color_two">
                  <Link href="/service">
                    <div className="image">
                      <img
                        className="img-fluid"
                        src="/assets/images/service/service-5-min.jpg"
                        alt="Car Insurance"
                      />
                    </div>
                  </Link>
                ...
                <div className="service_box type_one color_two">
                  <Link href="/service">
                    <div className="image">
                      <img
                        className="img-fluid"
                        src="/assets/images/service/service-6-min.jpg"
                        alt="Car Insurance"
                      />
                    </div>
                  </Link>
                  <div className="content_box">
                    <div className="content_inner trans">
                      ...
                      <p className="trans">
                        We cover you for wedding cancel, material damage to the
                        property
                      </p>
                      <Link href="/service" className="rd_more trans">
                        Read More
                ...
                <div className="service_box type_one color_two">
                  <Link href="/service/">
                    <div className="image">
                      <img
                        className="img-fluid"
                        src="/assets/images/service/service-7-min.jpg"
                        alt="Car Insurance"
                      />
                    </div>
                  </Link>
                ...
                <div className="service_box type_one color_two">
                  <Link href="/service">
                    <div className="image">
                      <img
                        className="img-fluid"
                        src="/assets/images/service/service-8-min.jpg"
                        alt="Car Insurance"
                      />
                    </div>
                  </Link>
                  <div className="content_box">
                    <div className="content_inner trans">
                      ...
                      <h4 className="title_24 trans">
                        <Link href="/service">Medical Insurance</Link>
                      </h4>
                      <p className="trans">
                ...
                <div className="service_box type_one color_two">
                  <Link href="/service">
                    <div className="image">
                      <img
                        className="img-fluid"
                        src="/assets/images/service/service-1-min-1.jpg"
                        alt="Car Insurance"
                      />
                    </div>
                  </Link>
