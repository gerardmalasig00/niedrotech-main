...
export default function ServiceStyle2() {
  ...
  const { offerSection, popularServicesSection, greatOfferSection } =
    contentConfig?.servicesConfig;
  return (
    <>
        ...
        <section className="service-section">
          ...
          <div className="container">
            <div className="row align-items-end">
              <div className="col-lg-6 col-md-6 col-sm-12">
                <div className="section_title type_one">
                  <h4 className="sm_title">{offerSection?.subtitle}</h4>
            ...
            <div className="service_post position-relative  ajax_service_enabled ">
              <div className="row">
                {offerSection?.services?.map((item, index) => (
                  <div className="col-xl-4 col-lg-4 col-md-6 col-sm-6">
                    <div className="service_box type_two hover_1_get">
                      ...
                      <div className="content_box trans">
                        ...
                        <div className="steps trans">
                          {item?.step ?? index + 1}
                        </div>
                        <h4 className="title_24 trans">
                          <Link href="/service">{item?.title}</Link>
                        </h4>
                        <p className="trans">{item?.description}</p>
          ...
          <div className="position-relative z_1">
            <div className="container pd_zero">
              ...
              <div className="row  mr_left_minus_15 mr_right_minus_15">
                {popularServicesSection?.services?.map((item, index) => (
                  <div className="col-xl-4 col-lg-4 col-md-6 col-sm-6 ">
                  ...
                  <div className="service_box type_five style_two icon_box_only type_three trans">
                    <div className="icon_inner trans">
                      <div className="d-flex trans">
                        ...
                        <div className="content">
                          <div className="title_22">
                            <Link href="/service">Marriage insurance</Link>
                          </div>
                          <p className="trans">
                  ...
                  <div className="service_box type_five style_two icon_box_only type_three trans">
                    <div className="icon_inner trans">
                      <div className="d-flex trans">
                        ...
                        <div className="content">
                          <div className="title_22">
                            <Link href="/service">Car Insurance</Link>
                          </div>
                          <p className="trans">
                  ...
                  <div className="service_box type_five style_two icon_box_only type_three trans">
                    <div className="icon_inner trans">
                      <div className="d-flex trans">
                        ...
                        <div className="content">
                          <div className="title_22">
                            <Link href="/service">Fire Insurance</Link>
                          </div>
                          <p className="trans">
                  ...
                  <div className="service_box type_five style_two  icon_box_only type_three trans">
                    <div className="icon_inner trans">
                      <div className="d-flex trans">
                        ...
                        <div className="content">
                          <div className="title_22">
                            <Link href="/service">House Insurance</Link>
                          </div>
                          <p className="trans">
        ...
        <section className="service-section position-relative">
          <div className="medium-container-two">
            <div className="row">
              <div className="col-lg-12">
                <div className="section_title text-center type_one">
                  <h4 className="sm_title">{greatOfferSection?.title}</h4>
                  <div className="title_whole">
                    <h2 className="title">{greatOfferSection?.subTitle}</h2>
                  </div>
                </div>
              </div>
            </div>
            ...
            <div className="service_post position-relative">
              <div className="row">
                {greatOfferSection?.services.map((item, index) => (
                ...
                {/* <div className="col-xl-3 col-lg-4 col-md-6 col-sm-6">
                  <div className="service_box type_three hover_1_get">
                    <Link href="/service" className="img_bx">
                      <div className="image trans hover_1">
                        <img
                          src="/assets/images/service/service-2-min-1.jpg"
                          className="img-fluid"
                          alt="service"
                        />
                        <div className="oh ho_1" />
                ...
                <div className="col-xl-3 col-lg-4 col-md-6 col-sm-6">
                  <div className="service_box type_three hover_1_get">
                    <Link href="/service" className="img_bx">
                      <div className="image trans hover_1">
                        <img
                          src="/assets/images/service/service-3-min.jpg"
                          className="img-fluid"
                          alt="service"
                        />
                        <div className="oh ho_1" />
                ...
                <div className="col-xl-3 col-lg-4 col-md-6 col-sm-6">
                  <div className="service_box type_three hover_1_get">
                    <Link href="/service" className="img_bx">
                      <div className="image trans hover_1">
                        <img
                          src="/assets/images/service/service-4-min.jpg"
                          className="img-fluid"
                          alt="service"
                        />
                        <div className="oh ho_1" />
