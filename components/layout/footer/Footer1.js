          ...
          <div className="call_to_action style_one">
            <div className="section_title type_one">
              <div className="title_whole">
                <h2 className="title">Find Tech solution analyst</h2>
              </div>
            </div>
            ...
            <div className="d-flex align-items-center contact_header_one">
              ...
              <div className="content">
                ...
                <div className="title_20">
                  <Link href="tel:+000(123)45688">+000(123)456 88</Link>
                </div>
              </div>
            </div>
          </div>
              ...
              <div className="col-lg-4 col-md-6 col-sm-12 col-xs-12 pd_right_70">
                <div className="footer_widgets_box pd_bottom_30">
                  ...
                  <div className="position-relative color_white">
                    Ready to take your business to the next level? Book an
                    appointment with us today and discover how our cutting-edge
                    tech solutions can drive growth and innovation for your
                    business.
                  </div>
                  {/*-============spacing==========-*/}
                ...
                <div className="footer_widgets_box pd_bottom_30">
                  ...
                  <div className="g_box d-flex">
                    <Link className="trans" href="#">
                      <img
                        src="/assets/images/portfolio/project-1-min.png"
                        alt="img"
                        className="img-fluid"
                      />
                      <svg
                      ...
                      >
                        ...
                        ></circle>
                        <path
                          d="M22 33.25L33.25 22M33.25 22H24.8125M33.25 22V30.4375"
                          stroke="#2D947A"
                          strokeWidth="1.5"
                          strokeLinecap="round"
                    ...
                    <Link className="trans" href="#">
                      <img
                        src="/assets/images/portfolio/project-2-min.png"
                        alt="img"
                        className="img-fluid"
                      />
                      <svg
                    ...
                    <Link className="trans" href="#">
                      <img
                        src="/assets/images/portfolio/project-3-min.png"
                        alt="img"
                        className="img-fluid"
                      />
                      <svg
                    ...
                    <Link className="trans" href="#">
                      <img
                        src="/assets/images/portfolio/project-4-min.png"
                        alt="img"
                        className="img-fluid"
                      />
                      <svg
                    ...
                    <Link className="trans" href="#">
                      <img
                        src="/assets/images/portfolio/project-5-min.png"
                        alt="img"
                        className="img-fluid"
                      />
                      <svg
                    ...
                    <Link className="trans" href="#">
                      <img
                        src="/assets/images/portfolio/project-6-min.png"
                        alt="img"
                        className="img-fluid"
                      />
                      <svg
                    ...
                    <Link className="trans" href="#">
                      <img
                        src="/assets/images/portfolio/project-7-min.png"
                        alt="img"
                        className="img-fluid"
                      />
                      <svg
                    ...
                    <Link className="trans" href="#">
                      <img
                        src="/assets/images/portfolio/project-8-min.png"
                        alt="img"
                        className="img-fluid"
                      />
                      <svg
                    ...
                    <Link className="trans" href="#">
                      <img
                        src="/assets/images/portfolio/project-9-min.png"
                        alt="img"
                        className="img-fluid"
                      />
                      <svg
