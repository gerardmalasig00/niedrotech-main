                ...
                <div className="footer_widgets_box pd_bottom_30">
                  <div className="logo_box">
                    <Link href="#" className="logo navbar-brand">
                      <img
                        src="/assets/images/footer-logo-green.png"
                        alt="Vankine"
                  ...
                  <div className="position-relative color_white">
                    Sed ut perspiciatis omnis laudantium natus errors voluptatem
                ...
                <div className="footer_widgets_box pd_bottom_30">
                  ...
                  <div className="bottom_content">
                    <div className="color_white position_p_relative">
                      Sed ut perspiciatis unde omniste natus errors volupta
                      accus
                    </div>
                    {/*-============spacing==========-*/}
                    <div className="pd_bottom_25" />
