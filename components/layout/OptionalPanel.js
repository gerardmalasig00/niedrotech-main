...
export default function OptionalPanel({
  ...
  return (
    <>
      <div
        className={`option_panel-popup ${
          isOptionalPanel ? "popup-visible" : ""
        }`}
      >
          ...
          <div className="option_content scrollbarcolor ">
            <div className="log_bx">
              ...
              <div className="about_company">
                ...
                beguiled and demoralized by the charms pleasure moment so
                blinded desire that they cannot foresee the pain and trouble.{" "}
              </div>
            </div>
              ...
              <div className="contact_panel">
                <div className="c_pan">
                  <Link href="tel:9806071234">
                    <i className="fi-rr-phone-call" /> 9806071234{" "}
                  </Link>
                </div>
                <div className="c_pan">
                ...
                <div className="c_pan">
                  <a className="wk_hours">
                    <i className="fi-rr-time-check" /> Working Hours :{" "}
                    <span> Sun-monday, 09am-5pm </span>
                  </a>
                </div>
              </div>
              <div className="c_pan">
                {" "}
                © {new Date().getFullYear()} Niedrotech. All Rights Reserved.{" "}
              </div>
            </div>
          </div>
        </div>
