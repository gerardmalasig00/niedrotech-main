        ...
        >
          ...
          <SwiperSlide className="slide-item-content">
            <div
              ...
              style={{
                backgroundImage: "url(assets/images/slider/banner-6-1.jpg)",
              }}
            />
            <div className="slide-item content_left">
              ...
              >
                ...
                <p>
                  ...
                  this page. You can also email our support team at
                  allan@niedro.com
                </p>
          ...
          <SwiperSlide className="slide-item-content">
            <div
              className="image-layer"
              style={{
                backgroundImage: "url(assets/images/slider/banner-6-2.jpg)",
              }}
            />
            <div className="slide-item content_left">
              <div className="auto-container">
          ...
          <SwiperSlide className="slide-item-content">
            <div
              className="image-layer"
              style={{
                backgroundImage: "url(assets/images/slider/banner-6-3.jpg)",
              }}
            />
            <div className="slide-item content_left">
              <div className="auto-container">
